...
public class RedLipstick {
	public RedLipstick() {
        System.out.println("RedLipstick constructor called");
    }
    ...
    public void displayFieldsAndMethods() {
        ...
        //System.out.println(myShape.protectedField);     // Not accessible from here
        //System.out.println(myShape.defaultField);       // Not accessible from here
